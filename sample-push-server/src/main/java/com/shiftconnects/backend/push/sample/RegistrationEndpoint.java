 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "sample.push.backend.shiftconnects.com", ownerName = "sample.push.backend.shiftconnects.com", packagePath = ""))
